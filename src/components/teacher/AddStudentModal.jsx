...
export default function AddStudentModal({ onSave, onClose }) {
    ...
    <Modal onClose={onClose} panelClassName="max-w-md" zClassName="z-[60]">
      ...
      <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          <label htmlFor="new-student-name" className="text-sm font-bold text-on-surface-variant uppercase tracking-wider">Student Name</label>
          <input
            id="new-student-name"
            type="text"
            required
